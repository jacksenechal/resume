...
**Never in this repo.** Interview prep documents contain named interviewers, hiring managers
and recruiters, interview locations, and comp negotiation strategy. This repo is public.
...
The same rule covers anything else with third-party names, comp figures, or private strategy:
if it is not the resume itself, it does not go here.
