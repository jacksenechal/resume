...
- **Senior full-stack engineer** shipping AI-powered applications end-to-end — LLM integration, prompt engineering, tool use, Rails/React UI, cloud-native deployment
- **15+ years** building and shipping software, with **6+ years leading teams** as tech lead, architect, and engineering manager
...
- Hands-on with modern AI tooling: multi-LLM application development, MCP servers, AI evaluation frameworks, agentic coding workflows
- Strength in **technical leadership and architecture**: roadmapping, system design, mentoring, and stewarding rag-tag teams to durable outcomes
...
- **AI/LLM**: LLM application development, prompt engineering, tool use, context augmentation, multi-LLM integration, AI evaluation (AISI Inspect), MCP (Model Context Protocol), agentic coding workflows.
